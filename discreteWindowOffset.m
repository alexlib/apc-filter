function [x_grid_rect, y_grid_rect, ...
    x_grid_01, y_grid_01, ...
    x_grid_02, y_grid_02] = ...
    discreteWindowOffset(X_OLD, Y_OLD, U, V, ProcessingParameters, MASK) 
% Inputs: 
...
grid_offset_x = ProcessingParameters.Grid.Shift.X;
grid_offset_y = ProcessingParameters.Grid.Shift.Y;

% Create the initial rectangular grid
[x_grid_rect, y_grid_rect] = ...
    gridImage([imageHeight, imageWidth], ...
    [gridSpacingY gridSpacingX], gridBufferY, gridBufferX, grid_offset_y, grid_offset_x, MASK);
