...
image_dir = '~/Desktop/piv_test_images/tiffs/5.0_ul_min';
...
image_name_01 = sprintf('%s%02d%s', image_base_name, image_list_01(1), image_ext);
...
for k = 1 : num_images;
    ...
    image_name_01 = sprintf('%s%02d%s', image_base_name, image_list_01(k), image_ext);
    image_path_01 = fullfile(image_dir, image_name_01);
    
    image_name_02 = sprintf('%s%02d%s', image_base_name, image_list_02(k), image_ext);
